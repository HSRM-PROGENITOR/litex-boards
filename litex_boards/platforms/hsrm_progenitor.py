...
_io = [
    ...
    ("ddram", 0,
        ...
        Subsignal("dq",      Pins("T1 U3 U2 U1 Y2 W1 Y1 V2 V7 W9 AB7 AA8 AB8 AB6 Y8 Y9 AB1 AB5 AB3", 
                                  "AA1 Y4 AA5 AB2 W4 T4 U6 T6 AA6 Y6 T5 U5 R6"), IOStandard("SSTL15")),
    ...
    ("eth", 0,
        ...
        #Subsignal("int_n",  Pins("MISSING")),# Not available 
